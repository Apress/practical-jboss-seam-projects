        ...
        <table border="0">
            <tr>
                <td>
                    <h:form>
                        <table border="0">
                            <tr><td colspan="2">Select types for this gadget:</td></tr>
                            <tr>
                                <td>
                                    <h:selectManyCheckbox 
                                            value="#{reviewGadget.types}"
                        ...
                        <h:commandButton type="submit" value="Confirm"
                                         action="#{gadgetReview.saveTypeReviewData}"/>
                    </h:form>
                </td>
                <td>
                    <h:form>
                        ...
                        <h:commandButton type="submit" value="Create type"
