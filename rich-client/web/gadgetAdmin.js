...
Seam.Remoting.type.gadgetAdmin = function() {
  this.__callback = new Object();
  Seam.Remoting.type.gadgetAdmin.prototype.search = function(p0, callback) {
    return Seam.Remoting.execute(this, "search", [p0], callback);
  }
}
Seam.Remoting.type.gadgetAdmin.__name = "gadgetAdmin";

Seam.Component.register(Seam.Remoting.type.gadgetAdmin);
